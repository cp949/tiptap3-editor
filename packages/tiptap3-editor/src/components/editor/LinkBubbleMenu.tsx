...
export const LinkBubbleMenu: React.FC<LinkBubbleMenuProps> = ({ className }) => {
  ...
  return (
    <BubbleMenu 
        ...
        className={cn("te-flex te-items-center te-bg-white te-shadow-lg te-rounded-md te-border te-border-gray-200 te-p-1 te-gap-1", className)}
    >
      {isEditMode ? (
        <div className="te-flex te-flex-col te-p-3 te-gap-3 te-w-[320px]">
          <div className="te-flex te-flex-col te-gap-1.5">
            <span className="te-text-xs te-font-medium te-text-gray-500">Text</span>
            <input 
                ref={textInputRef}
          ...
          <div className="te-flex te-flex-col te-gap-1.5">
            <span className="te-text-xs te-font-medium te-text-gray-500">Link</span>
            <input 
                ref={urlInputRef}
        ...
        <>
            ...
            <ToolbarButton onClick={handleCopyLink} title="Copy Link">
             ...
             <ToolbarButton onClick={handleUnlink} title="Unlink" className="te-text-red-500 hover:te-bg-red-50">
                <Unlink size={16} />
            </ToolbarButton>
        </>
      )}

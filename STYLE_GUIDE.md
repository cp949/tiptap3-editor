...
> **참고 소스**: [`apps/playground/components/examples/styles/DarkThemeExample.tsx`](apps/playground/components/examples/styles/DarkThemeExample.tsx)
...
> **참고 소스**: [`apps/playground/components/examples/styles/NotionStyleExample.tsx`](apps/playground/components/examples/styles/NotionStyleExample.tsx)
...
> **참고 소스**: [`apps/playground/components/examples/styles/PastelThemeExample.tsx`](apps/playground/components/examples/styles/PastelThemeExample.tsx)
